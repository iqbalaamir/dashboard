    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-auto col-sm-2 sideNav d-flex flex-column justify-content-between min-vh-100">
          <div className="mt-3">
            <a
              className="text-decoration-none ms-3 d-flex align-items-center text-white customHeading"
              role="button"
            >
                 <i className="bi bi-emoji-smile-fill"></i>
              <span className="ms-2 d-none d-sm-inline">SB ADMIN</span>
            </a>
            ...
            <ul class="nav nav-pills flex-column mt-2 mt-sm-0" id="parentM">
              ...
              <li class="nav-item  my-1 py-2 py-sm-0">
                ...
                >
                  <li class="nav-item ">
                    <a class="nav-link text-white" href="/item1" aria-current="page">
                      <span className="d-none d-sm-inline"> Item</span>1
                    </a>
                  </li>
                  <li class="nav-item ">
                    <a class="nav-link text-white" href="/item2">
