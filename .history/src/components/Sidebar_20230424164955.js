    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-auto col-sm-2 bg-dark d-flex flex-column justify-content-between min-vh-100">
          <div>
            <a
              className="text-decoration-none text-center d-flex align-items-center text-white d-none d-sm-inline"
              role="button"
            >
            ...
            <ul class="nav nav-pills flex-column mt-2 mt-sm-0" id="parentM">
              <li class="nav-item  my-1 py-2 py-sm-0">
                <a class="nav-link text-white text-center text-sm-start" href="#" aria-current="page">
          ...
          <div class="dropdown open">
            ...
            >
              ...
              <span className="fs-5 ms-3 d-none d-sm-inline">Yourself</span>
            </a>
