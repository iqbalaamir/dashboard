  ...
  return (
    <Navbar expand="lg">
      <Container fluid>
        ...
        <i class="bi bi-person-circle" style={{fontSize: 30,marginTop:10, color: "cornflowerblue"}}></i> 
        </Navbar.Collapse>
        <Navbar.Collapse className="justify-content-end">
        <i class="bi bi-person-circle" style={{fontSize: 30,marginTop:10, color: "cornflowerblue"}}></i> 
        </Navbar.Collapse>
        <Navbar.Collapse className="justify-content-end">
          ...
          <b> Dauglas Mgee</b>  <i class="bi bi-person-circle" style={{fontSize: 30,marginTop:10, color: "cornflowerblue"}}></i> 
          </Navbar.Text>
        </Navbar.Collapse>
      </Container>
    </Navbar>
