      ...
      <div className="container-fluid">
        <div className="row g-3 my-2">
          <div className="col-md-3 p-1" >
            <div className="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded" style={{borderLeft:"solid",borderLeftWidth:"3px",borderLeftColor:"#4e73df"}}>
              <div>
             
                <p className="fs-12" style={{color:"#"}}>EARNINGS (Monthly)</p>
